          ...
          <div className="flex items-center gap-2 w-full">
            <div className="tracking-wide w-1/2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>:</span>
                <p className="text-sm font-semibold">{vehicle.engine_number}</p>
              </div>
              <div className="flex items-center gap-2">
                <h1 className="text-sm min-w-[120px]">Type</h1>
                <span>:</span>
                <p className="text-sm font-semibold">{vehicle.vehicle_type}</p>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="tracking-wide w-1/2">
              ...
              <div className="flex items-center gap-2">
                <h1 className="text-sm min-w-[250px]">Tax Token Expiry Date</h1>
                <span>:</span>
                <p className="text-sm font-semibold">
